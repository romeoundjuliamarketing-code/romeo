...
export default function VenueRatingSheet({
  visible,
  venueId,
  venueName,
  onClose,
  ...
  const { existingRating, submitRating } = useVenueRatings(venueId);
  ...
  async function handleSubmit(): Promise<void> {
    ...
    setLoading(true);
    const { error } = await submitRating(venueId, stars, comment.trim());
    setLoading(false);
    ...
    <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.headerRow}>
          <Text style={styles.heading}>Venue bewerten</Text>
        ...
        <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <TextInput
            ...
            placeholder="Wie war die Atmosphäre, das Venue, das Event?"
